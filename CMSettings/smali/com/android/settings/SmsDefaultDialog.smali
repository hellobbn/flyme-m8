.class public final Lorg/flerovium/settings/SmsDefaultDialog;
...
.method private buildDialog(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v6}, Lorg/flerovium/settings/SmsDefaultDialog;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iput-object v6, p0, Lorg/flerovium/settings/SmsDefaultDialog;->mNewSmsApplicationData:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;

    .line 73
    iget-object v6, p0, Lorg/flerovium/settings/SmsDefaultDialog;->mNewSmsApplicationData:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
    ...
    iget-object v7, p0, Lorg/flerovium/settings/SmsDefaultDialog;->mNewSmsApplicationData:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
    ...
    .line 88
    :cond_2
    iget-object v2, p0, Lorg/flerovium/settings/SmsDefaultDialog;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;

    .line 89
    .local v2, "p":Lcom/android/internal/app/AlertController$AlertParams;
    const v6, 0x7f0907d8

    invoke-virtual {p0, v6}, Lorg/flerovium/settings/SmsDefaultDialog;->getString(I)Ljava/lang/String;
    ...
    iget-object v8, p0, Lorg/flerovium/settings/SmsDefaultDialog;->mNewSmsApplicationData:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
    ...
    invoke-virtual {p0, v6, v7}, Lorg/flerovium/settings/SmsDefaultDialog;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lorg/flerovium/settings/SmsDefaultDialog;->getString(I)Ljava/lang/String;
    ...
    .line 102
    invoke-virtual {p0}, Lorg/flerovium/settings/SmsDefaultDialog;->setupAlert()V
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 57
    :pswitch_0
    iget-object v0, p0, Lorg/flerovium/settings/SmsDefaultDialog;->mNewSmsApplicationData:Lcom/android/internal/telephony/SmsApplication$SmsApplicationData;
    ...
    invoke-virtual {p0, v0}, Lorg/flerovium/settings/SmsDefaultDialog;->setResult(I)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 44
    invoke-virtual {p0}, Lorg/flerovium/settings/SmsDefaultDialog;->getIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p0, v2}, Lorg/flerovium/settings/SmsDefaultDialog;->setResult(I)V

    .line 48
    invoke-direct {p0, v1}, Lorg/flerovium/settings/SmsDefaultDialog;->buildDialog(Ljava/lang/String;)Z
    ...
    .line 49
    invoke-virtual {p0}, Lorg/flerovium/settings/SmsDefaultDialog;->finish()V
