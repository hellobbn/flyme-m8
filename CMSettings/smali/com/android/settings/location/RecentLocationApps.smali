.class public Lorg/flerovium/settings/location/RecentLocationApps;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/flerovium/settings/location/RecentLocationApps$PackageEntryClickedListener;
    }
.end annotation
...
# instance fields
.field private final mActivity:Lorg/flerovium/settings/SettingsActivity;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 48
    const-class v0, Lorg/flerovium/settings/location/RecentLocationApps;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lorg/flerovium/settings/location/RecentLocationApps;->TAG:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Lorg/flerovium/settings/SettingsActivity;)V
    .locals 1
    .param p1, "activity"    # Lorg/flerovium/settings/SettingsActivity;
    ...
    .line 57
    iput-object p1, p0, Lorg/flerovium/settings/location/RecentLocationApps;->mActivity:Lorg/flerovium/settings/SettingsActivity;

    .line 58
    invoke-virtual {p1}, Lorg/flerovium/settings/SettingsActivity;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v0

    iput-object v0, p0, Lorg/flerovium/settings/location/RecentLocationApps;->mPackageManager:Landroid/content/pm/PackageManager;

    .line 59
    return-void
.end method

.method static synthetic access$000(Lorg/flerovium/settings/location/RecentLocationApps;)Lorg/flerovium/settings/SettingsActivity;
    .locals 1
    .param p0, "x0"    # Lorg/flerovium/settings/location/RecentLocationApps;

    .prologue
    .line 47
    iget-object v0, p0, Lorg/flerovium/settings/location/RecentLocationApps;->mActivity:Lorg/flerovium/settings/SettingsActivity;

    return-object v0
.end method

.method private createRecentLocationEntry(Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/preference/Preference$OnPreferenceClickListener;)Lorg/flerovium/settings/location/DimmableIconPreference;
    .locals 2
    ...
    .prologue
    .line 88
    new-instance v0, Lorg/flerovium/settings/location/DimmableIconPreference;

    iget-object v1, p0, Lorg/flerovium/settings/location/RecentLocationApps;->mActivity:Lorg/flerovium/settings/SettingsActivity;

    invoke-direct {v0, v1, p4}, Lorg/flerovium/settings/location/DimmableIconPreference;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;)V

    .line 89
    .local v0, "pref":Lorg/flerovium/settings/location/DimmableIconPreference;
    invoke-virtual {v0, p1}, Lorg/flerovium/settings/location/DimmableIconPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 90
    invoke-virtual {v0, p2}, Lorg/flerovium/settings/location/DimmableIconPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v1}, Lorg/flerovium/settings/location/DimmableIconPreference;->setSummary(I)V

    .line 96
    :goto_0
    invoke-virtual {v0, p5}, Lorg/flerovium/settings/location/DimmableIconPreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
...
.method private getPreferenceFromOps(Landroid/os/UserManager;JLandroid/app/AppOpsManager$PackageOps;)Landroid/preference/Preference;
    ...
    .line 170
    sget-object v4, Lorg/flerovium/settings/location/RecentLocationApps;->TAG:Ljava/lang/String;
    ...
    .line 183
    .local v19, "preference":Lorg/flerovium/settings/location/DimmableIconPreference;
    :try_start_0
    ...
    iget-object v4, v0, Lorg/flerovium/settings/location/RecentLocationApps;->mActivity:Lorg/flerovium/settings/SettingsActivity;

    invoke-virtual {v4}, Lorg/flerovium/settings/SettingsActivity;->getResources()Landroid/content/res/Resources;
    ...
    iget-object v4, v0, Lorg/flerovium/settings/location/RecentLocationApps;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    .line 203
    :cond_6
    new-instance v9, Lorg/flerovium/settings/location/RecentLocationApps$PackageEntryClickedListener;
    ...
    invoke-direct {v9, v0, v1, v2}, Lorg/flerovium/settings/location/RecentLocationApps$PackageEntryClickedListener;-><init>(Lorg/flerovium/settings/location/RecentLocationApps;Ljava/lang/String;Landroid/os/UserHandle;)V

    move-object/from16 v4, p0

    invoke-direct/range {v4 .. v9}, Lorg/flerovium/settings/location/RecentLocationApps;->createRecentLocationEntry(Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/preference/Preference$OnPreferenceClickListener;)Lorg/flerovium/settings/location/DimmableIconPreference;
    :try_end_0
...
.method public getAppList()Ljava/util/List;
    ...
    iget-object v0, v0, Lorg/flerovium/settings/location/RecentLocationApps;->mActivity:Lorg/flerovium/settings/SettingsActivity;

    move-object/from16 v17, v0

    const-string v18, "appops"

    invoke-virtual/range {v17 .. v18}, Lorg/flerovium/settings/SettingsActivity;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v15, v8, v9, v7}, Lorg/flerovium/settings/location/RecentLocationApps;->getPreferenceFromOps(Landroid/os/UserManager;JLandroid/app/AppOpsManager$PackageOps;)Landroid/preference/Preference;
