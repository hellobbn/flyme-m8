.class public Lorg/flerovium/settings/DeviceInfoSettings;
...
# instance fields
.field mAdvancedSettings:Lorg/flerovium/settings/cyanogenmod/SecureSettingSwitchPreference;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 499
    new-instance v0, Lorg/flerovium/settings/DeviceInfoSettings$1;

    invoke-direct {v0}, Lorg/flerovium/settings/DeviceInfoSettings$1;-><init>()V

    sput-object v0, Lorg/flerovium/settings/DeviceInfoSettings;->SEARCH_INDEX_DATA_PROVIDER:Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mHits:[J
...
.method static synthetic access$000(Landroid/content/Context;)Ljava/lang/String;
    ...
    .prologue
    .line 68
    invoke-static {p0}, Lorg/flerovium/settings/DeviceInfoSettings;->getFeedbackReporterPackage(Landroid/content/Context;)Ljava/lang/String;
...
.method public static getFormattedKernelVersion()Ljava/lang/String;
    ...
    invoke-static {v1}, Lorg/flerovium/settings/DeviceInfoSettings;->readLine(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Lorg/flerovium/settings/DeviceInfoSettings;->formatKernelVersion(Ljava/lang/String;)Ljava/lang/String;
    :try_end_0
...
.method private removePreferenceIfBoolFalse(Ljava/lang/String;Z)V
    ...
    .line 348
    invoke-virtual {p0, p1}, Lorg/flerovium/settings/DeviceInfoSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    .line 350
    invoke-virtual {p0}, Lorg/flerovium/settings/DeviceInfoSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
...
.method private removePreferenceIfPackageNotInstalled(Landroid/preference/Preference;)Z
    ...
    .line 584
    :try_start_0
    invoke-virtual {p0}, Lorg/flerovium/settings/DeviceInfoSettings;->getPackageManager()Landroid/content/pm/PackageManager;
...
.method private removePreferenceIfPropertyMissing(Landroid/preference/PreferenceGroup;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 338
    :try_start_0
    invoke-virtual {p0, p2}, Lorg/flerovium/settings/DeviceInfoSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method private sendFeedback()V
    ...
    .prologue
    .line 375
    invoke-virtual {p0}, Lorg/flerovium/settings/DeviceInfoSettings;->getActivity()Landroid/app/Activity;

    move-result-object v2

    invoke-static {v2}, Lorg/flerovium/settings/DeviceInfoSettings;->getFeedbackReporterPackage(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v2}, Lorg/flerovium/settings/DeviceInfoSettings;->startActivityForResult(Landroid/content/Intent;I)V
...
.method private setStringSummary(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lorg/flerovium/settings/DeviceInfoSettings;->getResources()Landroid/content/res/Resources;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v9}, Lorg/flerovium/settings/DeviceInfoSettings;->addPreferencesFromResource(I)V
    ...
    invoke-direct {p0, v9, v12}, Lorg/flerovium/settings/DeviceInfoSettings;->setStringSummary(Ljava/lang/String;Ljava/lang/String;)V

    .line 119
    const-string v9, "firmware_version"

    invoke-virtual {p0, v9}, Lorg/flerovium/settings/DeviceInfoSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-direct {p0, v9, v4}, Lorg/flerovium/settings/DeviceInfoSettings;->setStringSummary(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v9, v12}, Lorg/flerovium/settings/DeviceInfoSettings;->setValueSummary(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {}, Lorg/flerovium/settings/DeviceInfoSettings;->getFormattedKernelVersion()Ljava/lang/String;
    ...
    invoke-direct {p0, v9, v7}, Lorg/flerovium/settings/DeviceInfoSettings;->setStringSummary(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v9, v12}, Lorg/flerovium/settings/DeviceInfoSettings;->removePreferenceIfBoolFalse(Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, v9, v12, v13}, Lorg/flerovium/settings/DeviceInfoSettings;->removePreferenceIfPropertyMissing(Landroid/preference/PreferenceGroup;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v9}, Lorg/flerovium/settings/DeviceInfoSettings;->removePreferenceIfPackageNotInstalled(Landroid/preference/Preference;)Z
    ...
    invoke-static {v9}, Lorg/flerovium/settings/Utils;->isWifiOnly(Landroid/content/Context;)Z
    ...
    invoke-static {v9}, Lorg/flerovium/settings/Utils;->showSimCardTile(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v12}, Lorg/flerovium/settings/DeviceInfoSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    invoke-static {v9}, Lorg/flerovium/settings/DeviceInfoSettings;->getFeedbackReporterPackage(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v9, v10}, Lorg/flerovium/settings/Utils;->updatePreferenceToSpecificActivityOrRemove(Landroid/content/Context;Landroid/preference/PreferenceGroup;Ljava/lang/String;I)Z
    ...
    check-cast v9, Lorg/flerovium/settings/cyanogenmod/SecureSettingSwitchPreference;

    iput-object v9, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mAdvancedSettings:Lorg/flerovium/settings/cyanogenmod/SecureSettingSwitchPreference;
    ...
    :goto_5
    invoke-direct {p0, v12, v9}, Lorg/flerovium/settings/DeviceInfoSettings;->removePreferenceIfBoolFalse(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v9}, Lorg/flerovium/settings/DeviceInfoSettings;->removePreference(Ljava/lang/String;)V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 249
    iget-object v4, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mHits:[J

    const/4 v5, 0x1

    iget-object v6, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mHits:[J

    const/4 v7, 0x0

    iget-object v8, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mHits:[J
    ...
    iget-object v5, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mHits:[J
    ...
    .line 256
    :try_start_0
    invoke-virtual {p0, v1}, Lorg/flerovium/settings/DeviceInfoSettings;->startActivity(Landroid/content/Intent;)V
    :try_end_0
    ...
    invoke-virtual {p0, v4}, Lorg/flerovium/settings/DeviceInfoSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 268
    :cond_3
    iget v4, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mDevHitCountdown:I
    ...
    iput v4, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mDevHitCountdown:I
    ...
    .line 274
    iget-object v4, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mDevHitToast:Landroid/widget/Toast;
    ...
    iput-object v4, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mDevHitToast:Landroid/widget/Toast;
    ...
    invoke-static {v4}, Lorg/flerovium/settings/search/Index;->getInstance(Landroid/content/Context;)Lorg/flerovium/settings/search/Index;
    ...
    invoke-virtual {v4, v5, v6, v7}, Lorg/flerovium/settings/search/Index;->updateFromClassNameResource(Ljava/lang/String;ZZ)V
    ...
    iget v7, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mDevHitCountdown:I
    ...
    iget v10, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mDevHitCountdown:I
    ...
    .line 304
    invoke-direct {p0}, Lorg/flerovium/settings/DeviceInfoSettings;->sendFeedback()V
...
.method public onResume()V
    ...
    .line 239
    iget-object v0, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mAdvancedSettings:Lorg/flerovium/settings/cyanogenmod/SecureSettingSwitchPreference;

    invoke-virtual {p0}, Lorg/flerovium/settings/DeviceInfoSettings;->getActivity()Landroid/app/Activity;

    move-result-object v1

    invoke-static {v1}, Lorg/flerovium/settings/SettingsActivity;->showAdvancedPreferences(Landroid/content/Context;)Z

    move-result v1

    invoke-virtual {v0, v1}, Lorg/flerovium/settings/cyanogenmod/SecureSettingSwitchPreference;->setChecked(Z)V
    ...
    :goto_0
    iput v0, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mDevHitCountdown:I

    .line 243
    const/4 v0, 0x0

    iput-object v0, p0, Lorg/flerovium/settings/DeviceInfoSettings;->mDevHitToast:Landroid/widget/Toast;
