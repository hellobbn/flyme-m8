.class public final Lorg/flerovium/settings/Utils;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/flerovium/settings/Utils;->BADNESS_COLORS:[I
...
.method public static buildGlobalChangeWarningDialog(Landroid/content/Context;ILjava/lang/Runnable;)Landroid/app/Dialog;
    ...
    new-instance v2, Lorg/flerovium/settings/Utils$1;

    invoke-direct {v2, p2}, Lorg/flerovium/settings/Utils$1;-><init>(Ljava/lang/Runnable;)V
...
.method public static createUserSpinnerAdapter(Landroid/os/UserManager;Landroid/content/Context;)Lorg/flerovium/settings/UserSpinnerAdapter;
    .locals 7
    ...
    .line 961
    .local v3, "userDetails":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lorg/flerovium/settings/UserSpinnerAdapter$UserDetails;>;"
    invoke-interface {v4}, Ljava/util/List;->size()I
    ...
    .line 963
    new-instance v6, Lorg/flerovium/settings/UserSpinnerAdapter$UserDetails;
    ...
    invoke-direct {v6, v5, p0, p1}, Lorg/flerovium/settings/UserSpinnerAdapter$UserDetails;-><init>(Landroid/os/UserHandle;Landroid/os/UserManager;Landroid/content/Context;)V
    ...
    .line 965
    :cond_1
    new-instance v5, Lorg/flerovium/settings/UserSpinnerAdapter;

    invoke-direct {v5, p1, v3}, Lorg/flerovium/settings/UserSpinnerAdapter;-><init>(Landroid/content/Context;Ljava/util/ArrayList;)V
...
.method public static forcePrepareCustomPreferencesList(Landroid/view/ViewGroup;Landroid/view/View;Landroid/widget/ListView;Z)V
    ...
    .line 544
    invoke-static {p0, p1, p2, p3}, Lorg/flerovium/settings/Utils;->prepareCustomPreferencesList(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;Z)V
...
.method public static formatPercentage(I)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lorg/flerovium/settings/Utils;->formatPercentage(D)Ljava/lang/String;
...
.method public static getBatteryPercentage(Landroid/content/Intent;)Ljava/lang/String;
    ...
    .prologue
    .line 455
    invoke-static {p0}, Lorg/flerovium/settings/Utils;->getBatteryLevel(Landroid/content/Intent;)I

    move-result v0

    invoke-static {v0}, Lorg/flerovium/settings/Utils;->formatPercentage(I)Ljava/lang/String;
...
.method public static getDefaultIpAddresses(Landroid/net/ConnectivityManager;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lorg/flerovium/settings/Utils;->formatIpAddresses(Landroid/net/LinkProperties;)Ljava/lang/String;
...
.method public static getMeProfileName(Landroid/content/Context;Z)Ljava/lang/String;
    ...
    .line 682
    invoke-static {p0}, Lorg/flerovium/settings/Utils;->getProfileDisplayName(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0}, Lorg/flerovium/settings/Utils;->getShorterNameIfPossible(Landroid/content/Context;)Ljava/lang/String;
...
.method public static getSecureTargetUser(Landroid/os/IBinder;Landroid/os/UserManager;Landroid/os/Bundle;Landroid/os/Bundle;)Landroid/os/UserHandle;
    ...
    .line 990
    invoke-static {p1, v7}, Lorg/flerovium/settings/Utils;->isProfileOf(Landroid/os/UserManager;Landroid/os/UserHandle;)Z
    ...
    const-string v8, "android.intent.settings.USER"
    ...
    .line 996
    .local v4, "settingssUser":Landroid/os/UserHandle;
    :goto_1
    if-eqz v4, :cond_2
    ...
    invoke-static {p1, v4}, Lorg/flerovium/settings/Utils;->isProfileOf(Landroid/os/UserManager;Landroid/os/UserHandle;)Z
    ...
    .end local v4    # "settingssUser":Landroid/os/UserHandle;
    :cond_1
    move-object v4, v1
    ...
    .line 1002
    .restart local v4    # "settingssUser":Landroid/os/UserHandle;
    :cond_2
    if-eqz p2, :cond_3
    ...
    invoke-static {p1, v1}, Lorg/flerovium/settings/Utils;->isProfileOf(Landroid/os/UserManager;Landroid/os/UserHandle;)Z
    :try_end_0
...
.method private static getShorterNameIfPossible(Landroid/content/Context;)Ljava/lang/String;
    ...
    .prologue
    .line 689
    invoke-static {p0}, Lorg/flerovium/settings/Utils;->getLocalProfileGivenName(Landroid/content/Context;)Ljava/lang/String;
...
.method private static getSystemSignature(Landroid/content/pm/PackageManager;)Landroid/content/pm/Signature;
    ...
    invoke-static {v0}, Lorg/flerovium/settings/Utils;->getFirstSignature(Landroid/content/pm/PackageInfo;)Landroid/content/pm/Signature;
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static getUserIcon(Landroid/content/Context;Landroid/os/UserManager;Landroid/content/pm/UserInfo;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, v0}, Lorg/flerovium/settings/drawable/CircleFramedDrawable;->getInstance(Landroid/content/Context;Landroid/graphics/Bitmap;)Lorg/flerovium/settings/drawable/CircleFramedDrawable;
    ...
    .line 1135
    invoke-static {p0, v1}, Lorg/flerovium/settings/drawable/CircleFramedDrawable;->getInstance(Landroid/content/Context;Landroid/graphics/Bitmap;)Lorg/flerovium/settings/drawable/CircleFramedDrawable;
...
.method public static getWifiIpAddresses(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lorg/flerovium/settings/Utils;->formatIpAddresses(Landroid/net/LinkProperties;)Ljava/lang/String;
...
.method public static isPackageInstalled(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1, v0}, Lorg/flerovium/settings/Utils;->isPackageInstalled(Landroid/content/Context;Ljava/lang/String;Z)Z
...
.method public static isSystemPackage(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
    ...
    .line 1176
    sget-object v2, Lorg/flerovium/settings/Utils;->sSystemSignature:[Landroid/content/pm/Signature;
    ...
    invoke-static {p0}, Lorg/flerovium/settings/Utils;->getSystemSignature(Landroid/content/pm/PackageManager;)Landroid/content/pm/Signature;

    move-result-object v3

    aput-object v3, v2, v1

    sput-object v2, Lorg/flerovium/settings/Utils;->sSystemSignature:[Landroid/content/pm/Signature;
    ...
    invoke-static {p1}, Lorg/flerovium/settings/Utils;->getFirstSignature(Landroid/content/pm/PackageInfo;)Landroid/content/pm/Signature;
...
.method public static onBuildStartFragmentIntent(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;ILjava/lang/CharSequence;Z)Landroid/content/Intent;
    ...
    .line 898
    const-class v1, Lorg/flerovium/settings/SubSettings$BluetoothSubSettings;
    ...
    .line 901
    :cond_0
    const-class v1, Lorg/flerovium/settings/SubSettings;
...
.method public static startWithFragment(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;IILjava/lang/CharSequence;)V
    ...
    invoke-static/range {v0 .. v8}, Lorg/flerovium/settings/Utils;->startWithFragment(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;ILjava/lang/String;ILjava/lang/CharSequence;Z)V
...
.method public static startWithFragment(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;IILjava/lang/CharSequence;Z)V
    ...
    invoke-static/range {v0 .. v6}, Lorg/flerovium/settings/Utils;->onBuildStartFragmentIntent(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;ILjava/lang/CharSequence;Z)Landroid/content/Intent;
...
.method public static updatePreferenceToSpecificActivityFromMetaDataOrRemove(Landroid/content/Context;Landroid/preference/PreferenceGroup;Ljava/lang/String;)Z
    ...
    .line 256
    instance-of v14, v9, Lorg/flerovium/settings/IconPreferenceScreen;
    ...
    .line 278
    check-cast v3, Lorg/flerovium/settings/IconPreferenceScreen;

    .line 279
    .local v3, "iconPreference":Lorg/flerovium/settings/IconPreferenceScreen;
    invoke-virtual {v3, v2}, Lorg/flerovium/settings/IconPreferenceScreen;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 283
    .end local v3    # "iconPreference":Lorg/flerovium/settings/IconPreferenceScreen;
    :cond_4
...
.method public static updateTileToSpecificActivityFromMetaDataOrRemove(Landroid/content/Context;Lorg/flerovium/settings/dashboard/DashboardTile;)Z
    .locals 14
    .param p0, "context"    # Landroid/content/Context;
    ...
    .prologue
    .line 301
    iget-object v2, p1, Lorg/flerovium/settings/dashboard/DashboardTile;->intent:Landroid/content/Intent;
    ...
    .line 342
    :cond_1
    iput-object v10, p1, Lorg/flerovium/settings/dashboard/DashboardTile;->title:Ljava/lang/CharSequence;

    .line 343
    iput-object v9, p1, Lorg/flerovium/settings/dashboard/DashboardTile;->summary:Ljava/lang/CharSequence;
    ...
    iput-object v11, p1, Lorg/flerovium/settings/dashboard/DashboardTile;->intent:Landroid/content/Intent;
