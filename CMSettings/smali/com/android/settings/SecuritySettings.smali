.class public Lorg/flerovium/settings/SecuritySettings;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/flerovium/settings/SecuritySettings$SecuritySearchIndexProvider;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/flerovium/settings/SecuritySettings;->TRUST_AGENT_INTENT:Landroid/content/Intent;
    ...
    sput-object v0, Lorg/flerovium/settings/SecuritySettings;->SWITCH_PREFERENCE_KEYS:[Ljava/lang/String;

    .line 582
    new-instance v0, Lorg/flerovium/settings/SecuritySettings$SecuritySearchIndexProvider;

    invoke-direct {v0}, Lorg/flerovium/settings/SecuritySettings$SecuritySearchIndexProvider;-><init>()V

    sput-object v0, Lorg/flerovium/settings/SecuritySettings;->SEARCH_INDEX_DATA_PROVIDER:Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;
...
.method static synthetic access$000(Lorg/flerovium/settings/SecuritySettings;)V
    .locals 0
    .param p0, "x0"    # Lorg/flerovium/settings/SecuritySettings;

    .prologue
    .line 79
    invoke-direct {p0}, Lorg/flerovium/settings/SecuritySettings;->updateDeviceLockState()V
...
.method private createPreferenceHierarchy()Landroid/preference/PreferenceScreen;
    ...
    .prologue
    .line 155
    invoke-virtual/range {p0 .. p0}, Lorg/flerovium/settings/SecuritySettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    .line 161
    :cond_0
    invoke-virtual/range {p0 .. p0}, Lorg/flerovium/settings/SecuritySettings;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    iput-boolean v0, v1, Lorg/flerovium/settings/SecuritySettings;->mIsPrimary:Z

    .line 167
    move-object/from16 v0, p0

    iget-boolean v0, v0, Lorg/flerovium/settings/SecuritySettings;->mIsPrimary:Z
    ...
    invoke-virtual {v0, v1}, Lorg/flerovium/settings/SecuritySettings;->addPreferencesFromResource(I)V
    ...
    :cond_2
    :goto_2
    invoke-virtual/range {p0 .. p0}, Lorg/flerovium/settings/SecuritySettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    invoke-virtual/range {p0 .. p0}, Lorg/flerovium/settings/SecuritySettings;->getResources()Landroid/content/res/Resources;
    ...
    iput-object v0, v1, Lorg/flerovium/settings/SecuritySettings;->mSmsSecurityCheck:Landroid/preference/ListPreference;

    .line 245
    move-object/from16 v0, p0

    iget-object v0, v0, Lorg/flerovium/settings/SecuritySettings;->mSmsSecurityCheck:Landroid/preference/ListPreference;
    ...
    invoke-direct {v0, v1}, Lorg/flerovium/settings/SecuritySettings;->updateSmsSecuritySummary(I)V
    ...
    iput-object v0, v1, Lorg/flerovium/settings/SecuritySettings;->mShowPassword:Landroid/preference/SwitchPreference;
    ...
    iput-object v0, v1, Lorg/flerovium/settings/SecuritySettings;->mResetCredentials:Landroid/preference/Preference;

    .line 257
    invoke-virtual/range {p0 .. p0}, Lorg/flerovium/settings/SecuritySettings;->getActivity()Landroid/app/Activity;
    ...
    iput-object v0, v1, Lorg/flerovium/settings/SecuritySettings;->mKeyStore:Landroid/security/KeyStore;
    ...
    iget-object v0, v0, Lorg/flerovium/settings/SecuritySettings;->mKeyStore:Landroid/security/KeyStore;
    ...
    invoke-virtual {v0, v1}, Lorg/flerovium/settings/SecuritySettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    iput-object v0, v1, Lorg/flerovium/settings/SecuritySettings;->mToggleAppInstallation:Landroid/preference/SwitchPreference;

    .line 280
    move-object/from16 v0, p0

    iget-object v0, v0, Lorg/flerovium/settings/SecuritySettings;->mToggleAppInstallation:Landroid/preference/SwitchPreference;

    move-object/from16 v25, v0

    invoke-direct/range {p0 .. p0}, Lorg/flerovium/settings/SecuritySettings;->isNonMarketAppsAllowed()Z
    ...
    iput-object v0, v1, Lorg/flerovium/settings/SecuritySettings;->mLockDeviceToCyanogenAccount:Landroid/preference/SwitchPreference;
    ...
    invoke-static/range {v25 .. v25}, Lorg/flerovium/settings/SecuritySettings;->hasKillSwitch(Landroid/content/Context;)Z
    ...
    iget-object v0, v0, Lorg/flerovium/settings/SecuritySettings;->mLockDeviceToCyanogenAccount:Landroid/preference/SwitchPreference;
    ...
    invoke-static/range {v25 .. v25}, Lorg/flerovium/settings/search/Index;->getInstance(Landroid/content/Context;)Lorg/flerovium/settings/search/Index;

    move-result-object v25

    const-class v26, Lorg/flerovium/settings/SecuritySettings;
    ...
    invoke-virtual/range {v25 .. v28}, Lorg/flerovium/settings/search/Index;->updateFromClassNameResource(Ljava/lang/String;ZZ)V
    ...
    .local v8, "i":I
    :goto_6
    sget-object v25, Lorg/flerovium/settings/SecuritySettings;->SWITCH_PREFERENCE_KEYS:[Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2}, Lorg/flerovium/settings/SecuritySettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    const-class v26, Lorg/flerovium/settings/IccLockSettings;
...
.method public static getActiveTrustAgents(Landroid/content/pm/PackageManager;Lcom/android/internal/widget/LockPatternUtils;)Ljava/util/ArrayList;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "<",
            "Lorg/flerovium/settings/TrustAgentUtils$TrustAgentComponentInfo;",
            ">;"
        }
    .end annotation
    ...
    .line 323
    .local v4, "result":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lorg/flerovium/settings/TrustAgentUtils$TrustAgentComponentInfo;>;"
    sget-object v6, Lorg/flerovium/settings/SecuritySettings;->TRUST_AGENT_INTENT:Landroid/content/Intent;
    ...
    .line 330
    :cond_1
    invoke-static {v2, p0}, Lorg/flerovium/settings/TrustAgentUtils;->checkProvidePermission(Landroid/content/pm/ResolveInfo;Landroid/content/pm/PackageManager;)Z
    ...
    .line 331
    invoke-static {p0, v2}, Lorg/flerovium/settings/TrustAgentUtils;->getSettingsComponent(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Lorg/flerovium/settings/TrustAgentUtils$TrustAgentComponentInfo;

    move-result-object v5

    .line 333
    .local v5, "trustAgentComponentInfo":Lorg/flerovium/settings/TrustAgentUtils$TrustAgentComponentInfo;
    iget-object v6, v5, Lorg/flerovium/settings/TrustAgentUtils$TrustAgentComponentInfo;->componentName:Landroid/content/ComponentName;

    if-eqz v6, :cond_0

    invoke-static {v2}, Lorg/flerovium/settings/TrustAgentUtils;->getComponentName(Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;
    ...
    iget-object v6, v5, Lorg/flerovium/settings/TrustAgentUtils$TrustAgentComponentInfo;->title:Ljava/lang/String;
    ...
    .end local v5    # "trustAgentComponentInfo":Lorg/flerovium/settings/TrustAgentUtils$TrustAgentComponentInfo;
    :cond_2
    return-object v4
.end method
...
.method public static hasKillSwitch(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lorg/flerovium/settings/SecuritySettings;->hasCyanogenAccountType(Landroid/content/Context;)Z
    :try_end_0
...
.method private isNonMarketAppsAllowed()Z
    ...
    .line 418
    invoke-virtual {p0}, Lorg/flerovium/settings/SecuritySettings;->getContentResolver()Landroid/content/ContentResolver;
...
.method private setNonMarketAppsAllowed(Z)V
    ...
    .prologue
    .line 423
    invoke-virtual {p0}, Lorg/flerovium/settings/SecuritySettings;->getActivity()Landroid/app/Activity;
...
.method public static updateCyanogenDeviceLockState(Landroid/app/Fragment;ZI)V
    ...
    new-instance v2, Lorg/flerovium/settings/SecuritySettings$1;

    invoke-direct {v2, p1, p0, p2}, Lorg/flerovium/settings/SecuritySettings$1;-><init>(ZLandroid/app/Fragment;I)V
...
.method private updateDeviceLockState()V
    ...
    .prologue
    .line 470
    iget-object v0, p0, Lorg/flerovium/settings/SecuritySettings;->mLockDeviceToCyanogenAccount:Landroid/preference/SwitchPreference;
...
.method private updateSmsSecuritySummary(I)V
    ...
    invoke-virtual {p0, v1, v2}, Lorg/flerovium/settings/SecuritySettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :goto_0
    iget-object v1, p0, Lorg/flerovium/settings/SecuritySettings;->mSmsSecurityCheck:Landroid/preference/ListPreference;
    ...
    invoke-virtual {p0, v1}, Lorg/flerovium/settings/SecuritySettings;->getString(I)Ljava/lang/String;
...
.method private warnAppInstallation()V
    ...
    invoke-virtual {p0}, Lorg/flerovium/settings/SecuritySettings;->getResources()Landroid/content/res/Resources;
    ...
    iput-object v0, p0, Lorg/flerovium/settings/SecuritySettings;->mWarnInstallApps:Landroid/content/DialogInterface;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .prologue
    .line 445
    iget-object v1, p0, Lorg/flerovium/settings/SecuritySettings;->mWarnInstallApps:Landroid/content/DialogInterface;
    ...
    .local v0, "turnOn":Z
    :goto_0
    invoke-direct {p0, v0}, Lorg/flerovium/settings/SecuritySettings;->setNonMarketAppsAllowed(Z)V

    .line 448
    iget-object v1, p0, Lorg/flerovium/settings/SecuritySettings;->mToggleAppInstallation:Landroid/preference/SwitchPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lorg/flerovium/settings/SecuritySettings;->mSubscriptionManager:Landroid/telephony/SubscriptionManager;
    ...
    iput-object v0, p0, Lorg/flerovium/settings/SecuritySettings;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    .line 145
    const-string v0, "device_policy"

    invoke-virtual {p0, v0}, Lorg/flerovium/settings/SecuritySettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/app/admin/DevicePolicyManager;

    iput-object v0, p0, Lorg/flerovium/settings/SecuritySettings;->mDPM:Landroid/app/admin/DevicePolicyManager;
...
.method public onDestroy()V
    ...
    .line 457
    iget-object v0, p0, Lorg/flerovium/settings/SecuritySettings;->mWarnInstallApps:Landroid/content/DialogInterface;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 509
    iget-object v4, p0, Lorg/flerovium/settings/SecuritySettings;->mToggleAppInstallation:Landroid/preference/SwitchPreference;

    invoke-virtual {v4, v5}, Landroid/preference/SwitchPreference;->setChecked(Z)V

    .line 510
    invoke-direct {p0}, Lorg/flerovium/settings/SecuritySettings;->warnAppInstallation()V
    ...
    .line 514
    :cond_3
    invoke-direct {p0, v5}, Lorg/flerovium/settings/SecuritySettings;->setNonMarketAppsAllowed(Z)V
    ...
    .line 520
    invoke-direct {p0, v3}, Lorg/flerovium/settings/SecuritySettings;->updateSmsSecuritySummary(I)V
    ...
    invoke-direct {p0, v5}, Lorg/flerovium/settings/SecuritySettings;->hasLoggedInCyanogenAccount(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v4, v5}, Lorg/flerovium/settings/SecuritySettings;->updateCyanogenDeviceLockState(Landroid/app/Fragment;ZI)V
    ...
    new-instance v6, Lorg/flerovium/settings/SecuritySettings$2;

    invoke-direct {v6, p0}, Lorg/flerovium/settings/SecuritySettings$2;-><init>(Lorg/flerovium/settings/SecuritySettings;)V
    ...
    new-instance v6, Lorg/flerovium/settings/SecuritySettings$4;

    invoke-direct {v6, p0}, Lorg/flerovium/settings/SecuritySettings$4;-><init>(Lorg/flerovium/settings/SecuritySettings;)V
    ...
    new-instance v6, Lorg/flerovium/settings/SecuritySettings$3;

    invoke-direct {v6, p0}, Lorg/flerovium/settings/SecuritySettings$3;-><init>(Lorg/flerovium/settings/SecuritySettings;)V
...
.method public onResume()V
    ...
    .line 486
    invoke-direct {p0}, Lorg/flerovium/settings/SecuritySettings;->createPreferenceHierarchy()Landroid/preference/PreferenceScreen;

    .line 488
    iget-object v0, p0, Lorg/flerovium/settings/SecuritySettings;->mShowPassword:Landroid/preference/SwitchPreference;

    if-eqz v0, :cond_0

    .line 489
    iget-object v3, p0, Lorg/flerovium/settings/SecuritySettings;->mShowPassword:Landroid/preference/SwitchPreference;
    ...
    .line 493
    :cond_0
    iget-object v0, p0, Lorg/flerovium/settings/SecuritySettings;->mResetCredentials:Landroid/preference/Preference;
    ...
    iget-object v3, p0, Lorg/flerovium/settings/SecuritySettings;->mKeyStore:Landroid/security/KeyStore;
