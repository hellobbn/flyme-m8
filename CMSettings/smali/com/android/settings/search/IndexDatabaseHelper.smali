.class public Lorg/flerovium/settings/search/IndexDatabaseHelper;
...
.field private static sSingleton:Lorg/flerovium/settings/search/IndexDatabaseHelper;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/flerovium/settings/search/IndexDatabaseHelper;->INSERT_BUILD_VERSION:Ljava/lang/String;
...
.method private bootstrapDB(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 156
    sget-object v0, Lorg/flerovium/settings/search/IndexDatabaseHelper;->INSERT_BUILD_VERSION:Ljava/lang/String;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lorg/flerovium/settings/search/IndexDatabaseHelper;
    .locals 2
    .param p0, "context"    # Landroid/content/Context;

    .prologue
    .line 137
    const-class v1, Lorg/flerovium/settings/search/IndexDatabaseHelper;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lorg/flerovium/settings/search/IndexDatabaseHelper;->sSingleton:Lorg/flerovium/settings/search/IndexDatabaseHelper;

    if-nez v0, :cond_0

    .line 138
    new-instance v0, Lorg/flerovium/settings/search/IndexDatabaseHelper;

    invoke-direct {v0, p0}, Lorg/flerovium/settings/search/IndexDatabaseHelper;-><init>(Landroid/content/Context;)V

    sput-object v0, Lorg/flerovium/settings/search/IndexDatabaseHelper;->sSingleton:Lorg/flerovium/settings/search/IndexDatabaseHelper;
...
.method private reconstruct(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .prologue
    .line 194
    invoke-direct {p0, p1}, Lorg/flerovium/settings/search/IndexDatabaseHelper;->dropTables(Landroid/database/sqlite/SQLiteDatabase;)V

    .line 195
    invoke-direct {p0, p1}, Lorg/flerovium/settings/search/IndexDatabaseHelper;->bootstrapDB(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 190
    invoke-direct {p0, p1}, Lorg/flerovium/settings/search/IndexDatabaseHelper;->reconstruct(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1}, Lorg/flerovium/settings/search/IndexDatabaseHelper;->getBuildVersion(Landroid/database/sqlite/SQLiteDatabase;)Ljava/lang/String;
