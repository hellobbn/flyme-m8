.class public Lorg/flerovium/settings/search/Index;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/flerovium/settings/search/Index$1;,
        Lorg/flerovium/settings/search/Index$SaveSearchQueryTask;,
        Lorg/flerovium/settings/search/Index$UpdateIndexTask;,
        Lorg/flerovium/settings/search/Index$UpdateData;
    }
.end annotation
...
.field private static sInstance:Lorg/flerovium/settings/search/Index;
...
.field private final mDataToProcess:Lorg/flerovium/settings/search/Index$UpdateData;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/flerovium/settings/search/Index;->SELECT_COLUMNS:[Ljava/lang/String;
    ...
    sput-object v0, Lorg/flerovium/settings/search/Index;->MATCH_COLUMNS_PRIMARY:[Ljava/lang/String;
    ...
    sput-object v0, Lorg/flerovium/settings/search/Index;->MATCH_COLUMNS_SECONDARY:[Ljava/lang/String;

    .line 144
    const-wide/16 v0, 0x40

    sput-wide v0, Lorg/flerovium/settings/search/Index;->MAX_SAVED_SEARCH_QUERY:J
    ...
    sput-object v0, Lorg/flerovium/settings/search/Index;->EMPTY_LIST:Ljava/util/List;
    ...
    sput-object v0, Lorg/flerovium/settings/search/Index;->REMOVE_DIACRITICALS_PATTERN:Ljava/util/regex/Pattern;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lorg/flerovium/settings/search/Index;->mIsAvailable:Ljava/util/concurrent/atomic/AtomicBoolean;

    .line 204
    new-instance v0, Lorg/flerovium/settings/search/Index$UpdateData;

    invoke-direct {v0}, Lorg/flerovium/settings/search/Index$UpdateData;-><init>()V

    iput-object v0, p0, Lorg/flerovium/settings/search/Index;->mDataToProcess:Lorg/flerovium/settings/search/Index$UpdateData;

    .line 221
    iput-object p1, p0, Lorg/flerovium/settings/search/Index;->mContext:Landroid/content/Context;

    .line 222
    iput-object p2, p0, Lorg/flerovium/settings/search/Index;->mBaseAuthority:Ljava/lang/String;

    .line 223
    return-void
.end method

.method static synthetic access$200(Lorg/flerovium/settings/search/Index;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
    .param p0, "x0"    # Lorg/flerovium/settings/search/Index;

    .prologue
    .line 88
    iget-object v0, p0, Lorg/flerovium/settings/search/Index;->mIsAvailable:Ljava/util/concurrent/atomic/AtomicBoolean;

    return-object v0
.end method

.method static synthetic access$300(Lorg/flerovium/settings/search/Index;)Landroid/database/sqlite/SQLiteDatabase;
    .locals 1
    .param p0, "x0"    # Lorg/flerovium/settings/search/Index;

    .prologue
    .line 88
    invoke-direct {p0}, Lorg/flerovium/settings/search/Index;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method static synthetic access$400(Lorg/flerovium/settings/search/Index;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Landroid/provider/SearchIndexableData;Ljava/util/Map;)V
    .locals 0
    .param p0, "x0"    # Lorg/flerovium/settings/search/Index;
    ...
    .prologue
    .line 88
    invoke-direct {p0, p1, p2, p3, p4}, Lorg/flerovium/settings/search/Index;->indexOneSearchIndexableData(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Landroid/provider/SearchIndexableData;Ljava/util/Map;)V
...
.method static synthetic access$500()J
    ...
    .prologue
    .line 88
    sget-wide v0, Lorg/flerovium/settings/search/Index;->MAX_SAVED_SEARCH_QUERY:J
...
.method private addIndexablesForRawDataUri(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;[Ljava/lang/String;I)V
    ...
    .line 627
    .local v24, "userId":I
    new-instance v11, Lorg/flerovium/settings/search/SearchIndexableRaw;

    move-object/from16 v0, p1

    invoke-direct {v11, v0}, Lorg/flerovium/settings/search/SearchIndexableRaw;-><init>(Landroid/content/Context;)V

    .line 628
    .local v11, "data":Lorg/flerovium/settings/search/SearchIndexableRaw;
    move/from16 v0, v17

    iput v0, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->rank:I

    .line 629
    move-object/from16 v0, v23

    iput-object v0, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->title:Ljava/lang/String;

    .line 630
    move-object/from16 v0, v20

    iput-object v0, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->summaryOn:Ljava/lang/String;

    .line 631
    move-object/from16 v0, v19

    iput-object v0, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->summaryOff:Ljava/lang/String;

    .line 632
    iput-object v12, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->entries:Ljava/lang/String;

    .line 633
    iput-object v15, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->keywords:Ljava/lang/String;

    .line 634
    move-object/from16 v0, v18

    iput-object v0, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->screenTitle:Ljava/lang/String;

    .line 635
    iput-object v8, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->className:Ljava/lang/String;

    .line 636
    move-object/from16 v0, p2

    iput-object v0, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->packageName:Ljava/lang/String;

    .line 637
    iput v13, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->iconResId:I

    .line 638
    iput-object v7, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->intentAction:Ljava/lang/String;

    .line 639
    move-object/from16 v0, v22

    iput-object v0, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->intentTargetPackage:Ljava/lang/String;

    .line 640
    move-object/from16 v0, v21

    iput-object v0, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->intentTargetClass:Ljava/lang/String;

    .line 641
    iput-object v14, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->key:Ljava/lang/String;

    .line 642
    move/from16 v0, v24

    iput v0, v11, Lorg/flerovium/settings/search/SearchIndexableRaw;->userId:I

    .line 644
    move-object/from16 v0, p0

    invoke-virtual {v0, v11}, Lorg/flerovium/settings/search/Index;->addIndexableData(Landroid/provider/SearchIndexableData;)V
    :try_end_0
    ...
    .end local v11    # "data":Lorg/flerovium/settings/search/SearchIndexableRaw;
...
.method private addIndexablesForXmlResourceUri(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;[Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v14}, Lorg/flerovium/settings/search/Index;->addIndexableData(Landroid/provider/SearchIndexableData;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private addIndexablesFromRemoteProvider(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 323
    :try_start_0
    invoke-static {p2}, Lorg/flerovium/settings/search/Ranking;->getBaseRankForAuthority(Ljava/lang/String;)I

    move-result v5

    .line 325
    .local v5, "baseRank":I
    iget-object v0, p0, Lorg/flerovium/settings/search/Index;->mBaseAuthority:Ljava/lang/String;
    ...
    iget-object v1, p0, Lorg/flerovium/settings/search/Index;->mContext:Landroid/content/Context;

    .line 328
    .local v1, "context":Landroid/content/Context;
    :goto_0
    invoke-static {p2}, Lorg/flerovium/settings/search/Index;->buildUriForXmlResources(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-direct/range {v0 .. v5}, Lorg/flerovium/settings/search/Index;->addIndexablesForXmlResourceUri(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;[Ljava/lang/String;I)V

    .line 332
    invoke-static {p2}, Lorg/flerovium/settings/search/Index;->buildUriForRawData(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-direct/range {v6 .. v11}, Lorg/flerovium/settings/search/Index;->addIndexablesForRawDataUri(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;[Ljava/lang/String;I)V
    ...
    :cond_0
    iget-object v0, p0, Lorg/flerovium/settings/search/Index;->mContext:Landroid/content/Context;
...
.method private addNonIndexablesKeysFromRemoteProvider(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 345
    invoke-direct {p0, p1, p2}, Lorg/flerovium/settings/search/Index;->getNonIndexablesKeysFromRemoteProvider(Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;

    move-result-object v0

    .line 347
    .local v0, "keys":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    invoke-virtual {p0, p1, v0}, Lorg/flerovium/settings/search/Index;->addNonIndexableKeys(Ljava/lang/String;Ljava/util/List;)V
...
.method private buildSearchSQL(Ljava/lang/String;[Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2}, Lorg/flerovium/settings/search/Index;->buildSearchSQLForColumn(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method private buildSearchSQLForColumn(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    .local v0, "n":I
    :goto_0
    sget-object v2, Lorg/flerovium/settings/search/Index;->SELECT_COLUMNS:[Ljava/lang/String;
    ...
    .line 674
    invoke-direct {p0, p1, p2}, Lorg/flerovium/settings/search/Index;->buildSearchWhereStringForColumns(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method private buildSearchWhereStringForColumns(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 682
    invoke-direct {p0, p1, p2}, Lorg/flerovium/settings/search/Index;->buildSearchMatchStringForColumns(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method private getDataEntries(Landroid/content/Context;Landroid/util/AttributeSet;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lorg/flerovium/settings/search/Index;->getDataEntries(Landroid/content/Context;Landroid/util/AttributeSet;[II)Ljava/lang/String;
...
.method private getDataKey(Landroid/content/Context;Landroid/util/AttributeSet;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lorg/flerovium/settings/search/Index;->getData(Landroid/content/Context;Landroid/util/AttributeSet;[II)Ljava/lang/String;
...
.method private getDataKeywords(Landroid/content/Context;Landroid/util/AttributeSet;)Ljava/lang/String;
    ...
    .prologue
    .line 1109
    sget-object v0, Lorg/flerovium/settings/R$styleable;->Preference:[I
...
.method private static getIndexableClass(Ljava/lang/String;)Ljava/lang/Class;
    ...
    invoke-static {v0}, Lorg/flerovium/settings/search/Index;->isIndexableClass(Ljava/lang/Class;)Z
...
.method public static getInstance(Landroid/content/Context;)Lorg/flerovium/settings/search/Index;
    .locals 2
    .param p0, "context"    # Landroid/content/Context;

    .prologue
    .line 212
    sget-object v0, Lorg/flerovium/settings/search/Index;->sInstance:Lorg/flerovium/settings/search/Index;

    if-nez v0, :cond_0

    .line 213
    new-instance v0, Lorg/flerovium/settings/search/Index;

    const-string v1, "com.android.settings"

    invoke-direct {v0, p0, v1}, Lorg/flerovium/settings/search/Index;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    sput-object v0, Lorg/flerovium/settings/search/Index;->sInstance:Lorg/flerovium/settings/search/Index;
    ...
    invoke-virtual {v0, p0}, Lorg/flerovium/settings/search/Index;->setContext(Landroid/content/Context;)V
...
.method private getNonIndexablesKeys(Landroid/content/Context;Landroid/net/Uri;[Ljava/lang/String;)Ljava/util/List;
    ...
    .line 373
    sget-object v9, Lorg/flerovium/settings/search/Index;->EMPTY_LIST:Ljava/util/List;
...
.method private getNonIndexablesKeysFromRemoteProvider(Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 353
    :try_start_0
    iget-object v3, p0, Lorg/flerovium/settings/search/Index;->mContext:Landroid/content/Context;
    ...
    invoke-static {p2}, Lorg/flerovium/settings/search/Index;->buildUriForNonIndexableKeys(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-direct {p0, v1, v2, v3}, Lorg/flerovium/settings/search/Index;->getNonIndexablesKeys(Landroid/content/Context;Landroid/net/Uri;[Ljava/lang/String;)Ljava/util/List;
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 361
    sget-object v3, Lorg/flerovium/settings/search/Index;->EMPTY_LIST:Ljava/util/List;
...
.method private getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0}, Lorg/flerovium/settings/search/IndexDatabaseHelper;->getInstance(Landroid/content/Context;)Lorg/flerovium/settings/search/IndexDatabaseHelper;

    move-result-object v0

    invoke-virtual {v0}, Lorg/flerovium/settings/search/IndexDatabaseHelper;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method private getSearchIndexProvider(Ljava/lang/Class;)Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/Class",
            "<*>;)",
            "Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;"
        }
    .end annotation
    ...
    check-cast v3, Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;
    :try_end_0
...
.method private getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {v0}, Lorg/flerovium/settings/search/IndexDatabaseHelper;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method private indexFromProvider(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;Ljava/lang/String;IIZLjava/util/List;)V
    .locals 28
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "database"    # Landroid/database/sqlite/SQLiteDatabase;
    .param p3, "localeStr"    # Ljava/lang/String;
    .param p4, "provider"    # Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;
    ...
    invoke-interface {v0, v1, v2}, Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;->getRawDataToIndex(Landroid/content/Context;Z)Ljava/util/List;

    move-result-object v24

    .line 937
    .local v24, "rawList":Ljava/util/List;, "Ljava/util/List<Lorg/flerovium/settings/search/SearchIndexableRaw;>;"
    if-eqz v24, :cond_4
    ...
    check-cast v23, Lorg/flerovium/settings/search/SearchIndexableRaw;

    .line 943
    .local v23, "raw":Lorg/flerovium/settings/search/SearchIndexableRaw;
    move-object/from16 v0, v23

    iget-object v3, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->locale:Ljava/util/Locale;
    ...
    iget-object v3, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->key:Ljava/lang/String;
    ...
    iget-object v6, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->title:Ljava/lang/String;

    move-object/from16 v0, v23

    iget-object v7, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->summaryOn:Ljava/lang/String;

    move-object/from16 v0, v23

    iget-object v8, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->summaryOff:Ljava/lang/String;

    move-object/from16 v0, v23

    iget-object v9, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->entries:Ljava/lang/String;

    move-object/from16 v0, v23

    iget-object v11, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->screenTitle:Ljava/lang/String;

    move-object/from16 v0, v23

    iget-object v14, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->keywords:Ljava/lang/String;

    move-object/from16 v0, v23

    iget-object v15, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->intentAction:Ljava/lang/String;

    move-object/from16 v0, v23

    iget-object v0, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->intentTargetPackage:Ljava/lang/String;

    move-object/from16 v16, v0

    move-object/from16 v0, v23

    iget-object v0, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->intentTargetClass:Ljava/lang/String;

    move-object/from16 v17, v0

    move-object/from16 v0, v23

    iget-boolean v0, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->enabled:Z

    move/from16 v18, v0

    move-object/from16 v0, v23

    iget-object v0, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->key:Ljava/lang/String;

    move-object/from16 v19, v0

    move-object/from16 v0, v23

    iget v0, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->userId:I
    ...
    invoke-direct/range {v3 .. v20}, Lorg/flerovium/settings/search/Index;->updateOneRowWithFilteredData(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;I)V

    goto :goto_1

    .line 970
    .end local v21    # "i":I
    .end local v23    # "raw":Lorg/flerovium/settings/search/SearchIndexableRaw;
    ...
    invoke-interface {v0, v1, v2}, Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;->getXmlResourcesToIndex(Landroid/content/Context;Z)Ljava/util/List;
    ...
    invoke-direct/range {v3 .. v14}, Lorg/flerovium/settings/search/Index;->indexFromResource(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;ILjava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method private indexFromResource(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;ILjava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-direct {v0, v1, v2}, Lorg/flerovium/settings/search/Index;->getDataTitle(Landroid/content/Context;Landroid/util/AttributeSet;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2}, Lorg/flerovium/settings/search/Index;->getDataKey(Landroid/content/Context;Landroid/util/AttributeSet;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2}, Lorg/flerovium/settings/search/Index;->getDataSummary(Landroid/content/Context;Landroid/util/AttributeSet;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2}, Lorg/flerovium/settings/search/Index;->getDataKeywords(Landroid/content/Context;Landroid/util/AttributeSet;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2}, Lorg/flerovium/settings/search/Index;->getDataEntries(Landroid/content/Context;Landroid/util/AttributeSet;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2}, Lorg/flerovium/settings/search/Index;->getDataSummaryOn(Landroid/content/Context;Landroid/util/AttributeSet;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2}, Lorg/flerovium/settings/search/Index;->getDataSummaryOff(Landroid/content/Context;Landroid/util/AttributeSet;)Ljava/lang/String;
    ...
    invoke-direct/range {v20 .. v37}, Lorg/flerovium/settings/search/Index;->updateOneRowWithFilteredData(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;I)V
    :try_end_4
...
.method private indexOneRaw(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lorg/flerovium/settings/search/SearchIndexableRaw;)V
    .locals 19
    .param p1, "database"    # Landroid/database/sqlite/SQLiteDatabase;
    .param p2, "localeStr"    # Ljava/lang/String;
    .param p3, "raw"    # Lorg/flerovium/settings/search/SearchIndexableRaw;

    .prologue
    .line 721
    move-object/from16 v0, p3

    iget-object v1, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->locale:Ljava/util/Locale;
    ...
    iget-object v4, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->title:Ljava/lang/String;

    move-object/from16 v0, p3

    iget-object v5, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->summaryOn:Ljava/lang/String;

    move-object/from16 v0, p3

    iget-object v6, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->summaryOff:Ljava/lang/String;

    move-object/from16 v0, p3

    iget-object v7, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->entries:Ljava/lang/String;

    move-object/from16 v0, p3

    iget-object v8, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->className:Ljava/lang/String;

    move-object/from16 v0, p3

    iget-object v9, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->screenTitle:Ljava/lang/String;

    move-object/from16 v0, p3

    iget v10, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->iconResId:I

    move-object/from16 v0, p3

    iget v11, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->rank:I

    move-object/from16 v0, p3

    iget-object v12, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->keywords:Ljava/lang/String;

    move-object/from16 v0, p3

    iget-object v13, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->intentAction:Ljava/lang/String;

    move-object/from16 v0, p3

    iget-object v14, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->intentTargetPackage:Ljava/lang/String;

    move-object/from16 v0, p3

    iget-object v15, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->intentTargetClass:Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v18}, Lorg/flerovium/settings/search/Index;->updateOneRowWithFilteredData(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;I)V
...
.method private indexOneResource(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Landroid/provider/SearchIndexableResource;Ljava/util/Map;)V
    ...
    sget v2, Lorg/flerovium/settings/search/SearchIndexableResources;->NO_DATA_RES_ID:I
    ...
    invoke-direct/range {v1 .. v12}, Lorg/flerovium/settings/search/Index;->indexFromResource(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;ILjava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-static {v1}, Lorg/flerovium/settings/search/Index;->getIndexableClass(Ljava/lang/String;)Ljava/lang/Class;
    ...
    const-class v3, Lorg/flerovium/settings/search/Indexable;
    ...
    invoke-direct {v0, v13}, Lorg/flerovium/settings/search/Index;->getSearchIndexProvider(Ljava/lang/Class;)Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;

    move-result-object v7

    .line 794
    .local v7, "provider":Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;
    if-eqz v7, :cond_0
    ...
    invoke-interface {v7, v1}, Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;->getNonIndexableKeys(Landroid/content/Context;)Ljava/util/List;
    ...
    iget-object v4, v0, Lorg/flerovium/settings/search/Index;->mContext:Landroid/content/Context;
    ...
    invoke-direct/range {v3 .. v12}, Lorg/flerovium/settings/search/Index;->indexFromProvider(Landroid/content/Context;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;Ljava/lang/String;IIZLjava/util/List;)V
...
.method private indexOneSearchIndexableData(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Landroid/provider/SearchIndexableData;Ljava/util/Map;)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Lorg/flerovium/settings/search/Index;->indexOneResource(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Landroid/provider/SearchIndexableResource;Ljava/util/Map;)V
    ...
    :cond_1
    instance-of v0, p3, Lorg/flerovium/settings/search/SearchIndexableRaw;

    if-eqz v0, :cond_0

    .line 714
    check-cast p3, Lorg/flerovium/settings/search/SearchIndexableRaw;

    .end local p3    # "data":Landroid/provider/SearchIndexableData;
    invoke-direct {p0, p1, p2, p3}, Lorg/flerovium/settings/search/Index;->indexOneRaw(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lorg/flerovium/settings/search/SearchIndexableRaw;)V
...
.method private static isIndexableClass(Ljava/lang/Class;)Z
    ...
    const-class v0, Lorg/flerovium/settings/search/Indexable;
...
.method private isPrivilegedPackage(Ljava/lang/String;)Z
    ...
    .line 448
    iget-object v4, p0, Lorg/flerovium/settings/search/Index;->mContext:Landroid/content/Context;
...
.method private isWellKnownProvider(Landroid/content/pm/ResolveInfo;)Z
    ...
    .line 444
    invoke-direct {p0, v1}, Lorg/flerovium/settings/search/Index;->isPrivilegedPackage(Ljava/lang/String;)Z
...
.method private static normalizeString(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v2, Lorg/flerovium/settings/search/Index;->REMOVE_DIACRITICALS_PATTERN:Ljava/util/regex/Pattern;
...
.method private updateInternal()V
    ...
    .line 522
    iget-object v9, p0, Lorg/flerovium/settings/search/Index;->mDataToProcess:Lorg/flerovium/settings/search/Index$UpdateData;

    monitor-enter v9

    .line 523
    :try_start_0
    new-instance v7, Lorg/flerovium/settings/search/Index$UpdateIndexTask;

    const/4 v10, 0x0

    invoke-direct {v7, p0, v10}, Lorg/flerovium/settings/search/Index$UpdateIndexTask;-><init>(Lorg/flerovium/settings/search/Index;Lorg/flerovium/settings/search/Index$1;)V

    .line 524
    .local v7, "task":Lorg/flerovium/settings/search/Index$UpdateIndexTask;
    iget-object v10, p0, Lorg/flerovium/settings/search/Index;->mDataToProcess:Lorg/flerovium/settings/search/Index$UpdateData;

    invoke-virtual {v10}, Lorg/flerovium/settings/search/Index$UpdateData;->copy()Lorg/flerovium/settings/search/Index$UpdateData;

    move-result-object v2

    .line 525
    .local v2, "copy":Lorg/flerovium/settings/search/Index$UpdateData;
    iget-object v10, v2, Lorg/flerovium/settings/search/Index$UpdateData;->dataToUpdate:Ljava/util/List;
    ...
    invoke-static {v10}, Lorg/flerovium/settings/search/Index;->getIndexableClass(Ljava/lang/String;)Ljava/lang/Class;
    ...
    invoke-direct {p0, v1}, Lorg/flerovium/settings/search/Index;->getSearchIndexProvider(Ljava/lang/Class;)Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;

    move-result-object v5

    .line 532
    .local v5, "provider":Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;
    :goto_2
    if-eqz v5, :cond_0

    .line 533
    invoke-interface {v5}, Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;->prepare()V

    goto :goto_0

    .line 539
    .end local v1    # "clazz":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .end local v2    # "copy":Lorg/flerovium/settings/search/Index$UpdateData;
    .end local v3    # "data":Landroid/provider/SearchIndexableData;
    .end local v4    # "i$":Ljava/util/Iterator;
    .end local v5    # "provider":Lorg/flerovium/settings/search/Indexable$SearchIndexProvider;
    .end local v6    # "sir":Landroid/provider/SearchIndexableResource;
    .end local v7    # "task":Lorg/flerovium/settings/search/Index$UpdateIndexTask;
    :catchall_0
    move-exception v8
    ...
    .restart local v2    # "copy":Lorg/flerovium/settings/search/Index$UpdateData;
    ...
    .restart local v7    # "task":Lorg/flerovium/settings/search/Index$UpdateIndexTask;
    :cond_1
    move-object v1, v8
    ...
    :try_start_1
    new-array v8, v8, [Lorg/flerovium/settings/search/Index$UpdateData;

    const/4 v10, 0x0

    aput-object v2, v8, v10

    invoke-virtual {v7, v8}, Lorg/flerovium/settings/search/Index$UpdateIndexTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;

    .line 538
    iget-object v8, p0, Lorg/flerovium/settings/search/Index;->mDataToProcess:Lorg/flerovium/settings/search/Index$UpdateData;

    invoke-virtual {v8}, Lorg/flerovium/settings/search/Index$UpdateData;->clear()V
...
.method private updateOneRowWithFilteredData(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;I)V
    ...
    .prologue
    .line 1002
    invoke-static/range {p3 .. p3}, Lorg/flerovium/settings/search/Index;->normalizeHyphen(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .line 1003
    .local v3, "updatedTitle":Ljava/lang/String;
    invoke-static/range {p4 .. p4}, Lorg/flerovium/settings/search/Index;->normalizeHyphen(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    .line 1004
    .local v5, "updatedSummaryOn":Ljava/lang/String;
    invoke-static/range {p5 .. p5}, Lorg/flerovium/settings/search/Index;->normalizeHyphen(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    .line 1006
    .local v7, "updatedSummaryOff":Ljava/lang/String;
    invoke-static {v3}, Lorg/flerovium/settings/search/Index;->normalizeString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    .line 1007
    .local v4, "normalizedTitle":Ljava/lang/String;
    invoke-static {v5}, Lorg/flerovium/settings/search/Index;->normalizeString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    .line 1008
    .local v6, "normalizedSummaryOn":Ljava/lang/String;
    invoke-static {v7}, Lorg/flerovium/settings/search/Index;->normalizeString(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1010
    invoke-direct/range {v0 .. v20}, Lorg/flerovium/settings/search/Index;->updateOneRow(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;I)V
...
.method public addIndexableData(Landroid/provider/SearchIndexableData;)V
    ...
    .prologue
    .line 392
    iget-object v1, p0, Lorg/flerovium/settings/search/Index;->mDataToProcess:Lorg/flerovium/settings/search/Index$UpdateData;

    monitor-enter v1

    .line 393
    :try_start_0
    iget-object v0, p0, Lorg/flerovium/settings/search/Index;->mDataToProcess:Lorg/flerovium/settings/search/Index$UpdateData;

    iget-object v0, v0, Lorg/flerovium/settings/search/Index$UpdateData;->dataToUpdate:Ljava/util/List;
...
.method public addNonIndexableKeys(Ljava/lang/String;Ljava/util/List;)V
    ...
    iget-object v0, v0, Lorg/flerovium/settings/search/Index$UpdateData;->nonIndexableKeys:Ljava/util/Map;
...
.method public addSavedQuery(Ljava/lang/String;)J
    ...
    .line 287
    new-instance v1, Lorg/flerovium/settings/search/Index$SaveSearchQueryTask;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lorg/flerovium/settings/search/Index$SaveSearchQueryTask;-><init>(Lorg/flerovium/settings/search/Index;Lorg/flerovium/settings/search/Index$1;)V

    .line 288
    .local v1, "task":Lorg/flerovium/settings/search/Index$SaveSearchQueryTask;
    const/4 v2, 0x1
    ...
    invoke-virtual {v1, v2}, Lorg/flerovium/settings/search/Index$SaveSearchQueryTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;

    .line 290
    :try_start_0
    invoke-virtual {v1}, Lorg/flerovium/settings/search/Index$SaveSearchQueryTask;->get()Ljava/lang/Object;
...
.method public deleteIndexableData(Landroid/provider/SearchIndexableData;)V
    ...
    iget-object v0, v0, Lorg/flerovium/settings/search/Index$UpdateData;->dataToDelete:Ljava/util/List;
...
.method public getSuggestions(Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .prologue
    .line 255
    invoke-direct {p0, p1}, Lorg/flerovium/settings/search/Index;->buildSuggestionsSQL(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 257
    invoke-direct {p0}, Lorg/flerovium/settings/search/Index;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method public search(Ljava/lang/String;)Landroid/database/Cursor;
    ...
    sget-object v5, Lorg/flerovium/settings/search/Index;->MATCH_COLUMNS_PRIMARY:[Ljava/lang/String;

    invoke-direct {p0, p1, v5, v9}, Lorg/flerovium/settings/search/Index;->buildSearchSQL(Ljava/lang/String;[Ljava/lang/String;Z)Ljava/lang/String;
    ...
    sget-object v5, Lorg/flerovium/settings/search/Index;->MATCH_COLUMNS_SECONDARY:[Ljava/lang/String;

    invoke-direct {p0, p1, v5, v8}, Lorg/flerovium/settings/search/Index;->buildSearchSQL(Ljava/lang/String;[Ljava/lang/String;Z)Ljava/lang/String;
...
.method public update()V
    ...
    iget-object v7, p0, Lorg/flerovium/settings/search/Index;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v1}, Lorg/flerovium/settings/search/Index;->isWellKnownProvider(Landroid/content/pm/ResolveInfo;)Z
    ...
    invoke-direct {p0, v5, v0}, Lorg/flerovium/settings/search/Index;->addIndexablesFromRemoteProvider(Ljava/lang/String;Ljava/lang/String;)Z

    .line 315
    invoke-direct {p0, v5, v0}, Lorg/flerovium/settings/search/Index;->addNonIndexablesKeysFromRemoteProvider(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-direct {p0}, Lorg/flerovium/settings/search/Index;->updateInternal()V
...
.method public updateFromClassNameResource(Ljava/lang/String;ZZ)V
    ...
    .line 476
    :cond_0
    invoke-static {p1}, Lorg/flerovium/settings/search/SearchIndexableResources;->getResourceByName(Ljava/lang/String;)Landroid/provider/SearchIndexableResource;
    ...
    .line 484
    invoke-virtual {p0, v0}, Lorg/flerovium/settings/search/Index;->deleteIndexableData(Landroid/provider/SearchIndexableData;)V

    .line 486
    :cond_2
    invoke-virtual {p0, v0}, Lorg/flerovium/settings/search/Index;->addIndexableData(Landroid/provider/SearchIndexableData;)V
    ...
    iput-boolean v2, v1, Lorg/flerovium/settings/search/Index$UpdateData;->forceUpdate:Z
...
.method public updateFromSearchIndexableData(Landroid/provider/SearchIndexableData;)V
    ...
    .prologue
    .line 493
    invoke-virtual {p0, p1}, Lorg/flerovium/settings/search/Index;->addIndexableData(Landroid/provider/SearchIndexableData;)V
    ...
    iput-boolean v1, v0, Lorg/flerovium/settings/search/Index$UpdateData;->forceUpdate:Z
