.class public final Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;
...
.method public constructor <init>()V
    ...
    .line 49
    iput-object v0, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;

    .line 50
    iput-object v0, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
...
.method private checkUserChoice()Z
    ...
    iget v8, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
    ...
    .line 211
    :cond_0
    iget-object v8, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mContext:Landroid/content/Context;

    invoke-static {v8}, Lorg/flerovium/settings/bluetooth/LocalBluetoothManager;->getInstance(Landroid/content/Context;)Lorg/flerovium/settings/bluetooth/LocalBluetoothManager;

    move-result-object v0

    .line 212
    .local v0, "bluetoothManager":Lorg/flerovium/settings/bluetooth/LocalBluetoothManager;
    if-nez v0, :cond_1
    ...
    .line 218
    .local v2, "cachedDeviceManager":Lorg/flerovium/settings/bluetooth/CachedBluetoothDeviceManager;
    iget-object v8, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;

    invoke-virtual {v2, v8}, Lorg/flerovium/settings/bluetooth/CachedBluetoothDeviceManager;->findDevice(Landroid/bluetooth/BluetoothDevice;)Lorg/flerovium/settings/bluetooth/CachedBluetoothDevice;
    ...
    iget-object v10, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;

    invoke-virtual {v2, v8, v9, v10}, Lorg/flerovium/settings/bluetooth/CachedBluetoothDeviceManager;->addDevice(Lorg/flerovium/settings/bluetooth/LocalBluetoothAdapter;Lorg/flerovium/settings/bluetooth/LocalBluetoothProfileManager;Landroid/bluetooth/BluetoothDevice;)Lorg/flerovium/settings/bluetooth/CachedBluetoothDevice;
    ...
    .line 233
    :cond_5
    invoke-direct {p0, v11}, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->sendReplyIntentToReceiver(Z)V
    ...
    .line 236
    invoke-direct {p0, v7}, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->sendReplyIntentToReceiver(Z)V
...
.method private getNotificationTag(I)Ljava/lang/String;
    ...
    .line 190
    :cond_0
    iget v0, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
...
.method private sendReplyIntentToReceiver(Z)V
    ...
    iget-object v1, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
    ...
    iget-object v2, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
    ...
    iget-object v2, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    iget v2, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mRequestType:I

    invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    .line 272
    iget-object v1, p0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mContext:Landroid/content/Context;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iput-object v0, v1, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mContext:Landroid/content/Context;
    ...
    invoke-static {v14}, Lorg/flerovium/settings/Utils;->isManagedProfile(Landroid/os/UserManager;)Z
    ...
    :cond_1
    const-string v16, "android.bluetooth.device.settings.DEVICE"
    ...
    iput-object v0, v1, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;

    .line 68
    const-string v16, "android.bluetooth.device.settings.ACCESS_REQUEST_TYPE"
    ...
    iput v0, v1, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mRequestType:I

    .line 70
    const-string v16, "android.bluetooth.device.settings.PACKAGE_NAME"
    ...
    iput-object v0, v1, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;

    .line 71
    const-string v16, "android.bluetooth.device.settings.CLASS_NAME"
    ...
    iput-object v0, v1, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;

    .line 87
    invoke-direct/range {p0 .. p0}, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->checkUserChoice()Z
    ...
    const-class v16, Lorg/flerovium/settings/bluetooth/BluetoothPermissionActivity;
    ...
    iget v0, v0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mRequestType:I
    ...
    iget-object v0, v0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    iget-object v0, v0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mReturnPackage:Ljava/lang/String;
    ...
    iget-object v0, v0, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->mReturnClass:Ljava/lang/String;
    ...
    invoke-static {v0, v6}, Lorg/flerovium/settings/bluetooth/LocalBluetoothPreferences;->shouldShowDialogInForeground(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 131
    const-string v16, "android.bluetooth.device.settings.CONNECTION_ACCESS_RESULT"
    ...
    invoke-direct {v0, v1}, Lorg/flerovium/settings/bluetooth/BluetoothPermissionRequest;->getNotificationTag(I)Ljava/lang/String;
