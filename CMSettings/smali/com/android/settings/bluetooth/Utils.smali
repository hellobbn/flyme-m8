.class final Lorg/flerovium/settings/bluetooth/Utils;
...
.method static showError(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    .line 102
    :cond_0
    invoke-virtual {v1}, Lorg/flerovium/settings/bluetooth/LocalBluetoothManager;->getForegroundActivity()Landroid/content/Context;

    move-result-object v0

    .line 103
    .local v0, "activity":Landroid/content/Context;
    invoke-virtual {v1}, Lorg/flerovium/settings/bluetooth/LocalBluetoothManager;->isForegroundActivity()Z
...
.method public static updateSearchIndex(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IZ)V
    ...
    invoke-direct {v0, p0}, Lorg/flerovium/settings/search/SearchIndexableRaw;-><init>(Landroid/content/Context;)V

    .line 120
    .local v0, "data":Lorg/flerovium/settings/search/SearchIndexableRaw;
    iput-object p1, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->className:Ljava/lang/String;

    .line 121
    iput-object p2, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->title:Ljava/lang/String;

    .line 122
    iput-object p3, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->screenTitle:Ljava/lang/String;

    .line 123
    iput p4, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->iconResId:I

    .line 124
    iput-boolean p5, v0, Lorg/flerovium/settings/search/SearchIndexableRaw;->enabled:Z
    ...
    invoke-virtual {v1, v0}, Lorg/flerovium/settings/search/Index;->updateFromSearchIndexableData(Landroid/provider/SearchIndexableData;)V
